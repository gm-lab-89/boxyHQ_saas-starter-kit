...
const Header = ({ setSidebarOpen }: HeaderProps) => {
  ...
  return (
    <div className="sticky top-0 z-40 flex h-14 shrink-0 items-center border-b px-4 sm:gap-x-6 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <button
        type="button"
          ...
          <div className="dropdown dropdown-end">
            <div className="flex items-center cursor-pointer" tabIndex={0}>
              <span className="hidden lg:flex lg:items-center">
                <button
                  className="ml-4 text-sm font-semibold leading-6 text-neutral"
                  aria-hidden="true"
                >
                  {user.name}
                </button>
